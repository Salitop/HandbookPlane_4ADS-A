 ...
 */
@Controller
public class ListaDeTracosController {
     ...
     * @return ModelAndView
     */
    @GetMapping(value = "/listaDeTracos")
    public ModelAndView telalistaDeTracos() {
        Administrador administrador = administradorRepository.findByIdAdmin(Usuario.IdUsu);

        ModelAndView mv = new ModelAndView("/tracos/listaDeTracos");
