 ...
 */
@Controller
public class HistoricoDeTracosController {
     ...
     * @return ModelAndView
     */
    @GetMapping(value = "/historicoDeTracos")
    public ModelAndView telahistoricoDeTracos() {
        Administrador administrador = administradorRepository.findByIdAdmin(Usuario.IdUsu);

        ModelAndView mv = new ModelAndView("/tracos/historicoDeTracos");
